...
class AddKoiChar extends Migration
{
    ...
    public function up()
    {
        DB::table('character_themes')->insert(
            [
                ['id' => '12', 'name' => 'Tierra Koi', 'classes' => NULL],
            ]
        );
        DB::table('characters')->insert(
            [
                ['id' => '51', 'name' => 'delumion', 'character_theme_id' => '12', 'property' => 'fas fa-coins', 'classes' => 'koi-small'],
                ['id' => '52', 'name' => 'ganabia', 'character_theme_id' => '12', 'property' => 'fas fa-coins', 'classes' => 'koi-small'],
                ['id' => '53', 'name' => 'mundaraka', 'character_theme_id' => '12', 'property' => 'fas fa-heart', 'classes' => 'koi-small'],
                ['id' => '54', 'name' => 'laiona', 'character_theme_id' => '12', 'property' => 'fas fa-heart', 'classes' => 'koi-small'],
                ['id' => '55', 'name' => 'ionare', 'character_theme_id' => '12', 'property' => 'fas fa-fist-raised', 'classes' => 'koi-small'],
                ['id' => '56', 'name' => 'gespair', 'character_theme_id' => '12', 'property' => 'fas fa-fist-raised', 'classes' => NULL],
            ]
        );
