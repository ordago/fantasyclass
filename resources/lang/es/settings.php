...
return [
    ...
    */
    ...
    'disable_student_view' => 'Oculta al alumnado la información del resto',
    ...
    'sell_price' => 'Porcentaje de compra respecto al valor original"',
    ...
    'drive_unlink' => "Desenlaza Google Drive",


    'reset_assistant' => "Asistente de reinicio",
    'reset_assistant_help' => "Aquí podrás elegir reiniciar las principales propiedades de los estudiantes",

    'themes' => "Temas y avatares",
    ...
    'notifications_from_classroom' => "Deshabilita las notificaciones de esta clase",
    ...
    'share_code' => 'Código de compartición para importar a otras clases',
    'import_from_class' => 'Importa de otra clase',
    'import_code' => 'Pon el código de compartición de la clase',
