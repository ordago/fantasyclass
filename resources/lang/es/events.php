...
return [
    ...
    |
    */
    'curse_silence_title' => 'La maldición del silencio', 
    'curse_silence_content' => 'Hemos sido maldecidos por un hechizo que no nos permite hablar a ninguno de los presentes (incluso a Dios / la Diosa). Solo podremos deshacernos superando un reto propuesto.',
    'mirror' => 'El espejo', 
    'mirror_content' => 'Vamos a invertir la clase como si hubiera un espejo, los que estáis a la izquierda de la clase se posaréis a la derecha y los de la derecha a la izquierda.',
    ...
    'monty' => 'Los caballeros que dicen NI!', 
    ...
    'plague' => 'La peste', 
    'plague_content' => '<i class=\'fas fa-sad-tear colored\'></i> Uno de los héroes y heroinas se ha contagiado de la peste.',
    'panic' => 'Pánico total', 
    ...
    'breath' => 'Un respiro...', 
    'breath_content' => '<i class=\'fas fa-laugh-beam colored\'></i>&nbsp; El jugador con menos vida encuentra una &nbsp;<i class=\'fas fa-apple-alt\'></i>&nbsp; milagrosa:',
    'responsibility' => 'Reponsabilidad máxima', 
    'responsibility_content' => '<i class=\'fas fa-sad-tear colored\'></i> Un jugador tendrá que decidir quién de su equipo pierde vida, si no lo hace en 10 segundos será él elegido.',
    'walking' => 'The walking dead', 
    'walking_content' => '<i class=\'fas fa-laugh-beam colored\'></i> Un jugador muerto, vuelve a la vida con 1 de
 <i class=\'fas fa-heart colored\'></i>. Aprovéchalo!',
    ...
    'dragon_content_ko' => 'Salimos corriendo! Había dragones y nos han atacado!!!',
    'kiwi' => '<i class=\'fas fa-kiwi-bird\'></i> Un animal nos impide continuar el camino', 
