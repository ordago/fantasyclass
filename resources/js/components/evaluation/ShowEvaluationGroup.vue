<template>
    <div class="columns">
            ...
            <article class="panel is-sticky-panel is-info">
                <p class="panel-heading is-flex has-space-between align-items-center p-3">
                    ...
                    <button class="button"
                            ...
                            v-html="buttonAddGroup"></button>
                </p>

                <div class="panel-block is-flex is-flex-column p-0"
                     style="align-items: flex-start"
                     v-if="evaluablesgroup !== null"
                     v-for="evaluableGroup in evaluablesgroup"
                     v-bind:key="evaluableGroup.id">
                    <div @click="activeGroup = evaluableGroup;"
                  ...
                  evaluableGroup.name.length > 30
                    ...
                    <div @click="activeGroup = evaluationGroupChild;"
        ...
        <div class="column pr-0">
            <CreateEvaluationGroup :code="code" v-if="activeAddGroup" key></CreateEvaluationGroup>
            <TagManagement :code="code"
                           :evaluablegroup="activeGroup"
                           :key="activeGroup.id"
                           v-if="!activeAddGroup && activeGroup && !isLoading"></TagManagement>
        </div>
    </div>
</template>
<script>
