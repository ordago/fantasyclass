      ...
      <div class="columns">
        ...
        <div class="column is-narrow">
          ...
          >
            ...
            <img
              :src="'/img/cardgen/type_' + type + '.png'"
              v-if="!fullscreen"
              class="typeCard"
              id="circleType"
            />
            ...
            <img
              :src="'/img/cardgen/ribbon-' + type + '.png'"
              class="ribbon"
              id="ribbonType"
              v-if="!fullscreen"
            />
            <img
              :src="'/img/cardgen/only_back_' + type_bg + '.png'"
              class="background"
              v-if="!special && !fullscreen"
            />
            <img
              :src="'/img/cardgen/only_back_' + type_bg + '_gold.png'"
              class="background"
              v-if="special && !fullscreen"
            />
            <!-- Text -->
          ...
          <p>
            *<strong>Bold</strong>* // ^<em>Italic</em>^ // _ <u>Underline</u> _
            // [BR]
          </p>
        </div>
        <!-- END CARD -->
            ...
            <div class="field has-addons ml-2">
              ...
              <p class="control">
                <button
                  type="button"
                  class="button is-link"
                  @click="margin_left = margin_left - 5"
                >
                ...
                <div class="field has-addons">
                  ...
                  <p class="control select is-fullwidth">
                    <select v-model="type" class=" " name="type">
                      <option value="1">
                        {{ trans.get("settings.common") }}
                      </option>
                      <option value="2">
                        {{ trans.get("settings.rare") }}
                      </option>
                      <option value="3">
                        {{ trans.get("settings.epic") }}
                      </option>
                      <option value="4">
                        {{ trans.get("settings.legendary") }}
                      </option>
                    </select>
                  </p>
                </div>
