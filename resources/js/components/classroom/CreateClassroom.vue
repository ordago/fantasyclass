       ...
       <section>
         <b-tabs v-model="activeTab" >
            ...
            <b-tab-item :label="trans.get('classroom.char_theme')" icon="mask" icon-pack="far">
                ...
                <label>
                    <input type="radio" name="charTheme" class="hide-radios" value="2">
                ...
                <label>
                    <input type="radio" name="charTheme" class="hide-radios" value="3">
                    <img  src="/img/character/themes-preview/superheros.png" class="themePreview">
                </label>
                <label>
                    <input type="radio" name="charTheme" class="hide-radios" value="4">
                ...
                <label>
                    <input type="radio" name="charTheme" class="hide-radios" value="0">
