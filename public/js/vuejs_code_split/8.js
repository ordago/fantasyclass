...
var script = {
  ...
  methods: {
    async load() {
      const { writeFile } = await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.t.bind(null, /*! xlsx */ "./node_modules/xlsx/xlsx.js", 7));
...
var script = {
  ...
  methods: {
    async load() {
      const {
        utils: { sheet_to_json }
      } = await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.t.bind(null, /*! xlsx */ "./node_modules/xlsx/xlsx.js", 7));
...
var script = {
  ...
  methods: {
    async load() {
      ...
      globalPolyfill();
      const { read } = await Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(2)]).then(__webpack_require__.t.bind(null, /*! xlsx */ "./node_modules/xlsx/xlsx.js", 7));
      this._read = read;
      this.libLoaded = true;
      this._callbackQueue = [];
    },
